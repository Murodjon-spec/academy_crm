...
const addStudent = () => {
  const student = {
    ...
    img: 'https://media.contentapi.ea.com/content/dam/news/www-ea/images/2022/09/ea-motive-new-title-teaser-16x9-featured.jpg.adapt.crop191x100.628p.jpg',
            ...
            >
              ...
              <div class="flex flex-col items-center pb-10">
                <img
                  ...
                  src="https://media.contentapi.ea.com/content/dam/news/www-ea/images/2022/09/ea-motive-new-title-teaser-16x9-featured.jpg.adapt.crop191x100.628p.jpg"
                  alt="Bonnie image"
                />
